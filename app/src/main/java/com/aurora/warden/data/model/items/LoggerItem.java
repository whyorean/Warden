...
@Getter
@Setter
public class LoggerItem extends ListItem {

    private Logger logger;

    public LoggerItem(Logger logger) {
        this.logger = logger;
    }
    ...
    static class ViewHolder extends ListViewHolder {
        ...
        public void bindView(@NotNull ListItem item, @NotNull List<?> list) {
            ...
            final Logger logger = ((LoggerItem) item).getLogger();
            line1.setText(logger.getName());
            line2.setText(logger.getCodeSignature());
            line3.setText(logger.getWebsite());
