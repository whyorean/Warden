...
@Getter
@Setter
public class TrackerItem extends ListItem {
    ...
    static class ViewHolder extends ListViewHolder {
        ...
        public void bindView(@NotNull ListItem item, @NotNull List<?> list) {
            ...
            final Tracker tracker = ((TrackerItem) item).getTracker();
            line1.setText(tracker.getName());
            line2.setText(tracker.getCodeSignature());
            line3.setText(tracker.getWebsite());
