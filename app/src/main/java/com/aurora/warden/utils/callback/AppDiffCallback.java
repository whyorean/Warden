...
public class AppDiffCallback implements DiffCallback<AppItem> {
    ...
    @Nullable
    @Override
    public Object getChangePayload(AppItem oldItem, int oldPosition, AppItem newItem, int newPosition) {
        return null;
    }
}