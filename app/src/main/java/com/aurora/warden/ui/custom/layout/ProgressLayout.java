...
public class ProgressLayout extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ProgressLayout);
        final String txt = typedArray.getString(R.styleable.ProgressLayout_progressText);
